...
CUDA_VISIBLE_DEVICES= python ./scripts/worker.py --log-dir /tmp/marioKartLogs --env-id Mario-Kart-Discrete-Luigi-Raceway-v0 --job-name ps >/tmp/marioKartLogs/a3c.ps.out 2>&1 &
