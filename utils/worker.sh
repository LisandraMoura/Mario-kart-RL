...
CUDA_VISIBLE_DEVICES= python ./scripts/worker.py --log-dir /tmp/marioKartLogs --env-id Mario-Kart-Discrete-Moo-Moo-Farm-v0 --job-name worker --remotes 1 >/tmp/marioKartLogs/a3c.w-`hostname`.out 2>&1 &
